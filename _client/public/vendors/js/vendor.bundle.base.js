...
!function(t, e) {
  ...
  const t = t=>{
    ...
    , o = t=>{
      t.dispatchEvent ? t.dispatchEvent(new Event("transitionend")) : undefined;
  }
    , r = t=>(t[0] || t).nodeType
    , a = (t,e)=>{
      let i = !1;
      const n = e + 5;
      t.addEventListener ? t.addEventListener("transitionend", (function e() {
          i = !0,
  ...
  function N(t, e, i, n, s) {
      ...
      u.uidEvent = h,
      c[h] = u,
      t.addEventListener ? t.addEventListener(a, u, o) : undefined
  }
  ...
  class Ie extends M {
      ...
      show(t) {
        if(this._element == null){
          ...
          this._element.removeAttribute? this._element.removeAttribute("aria-hidden") : undefined,
          this._element.setAttribute? this._element.setAttribute("aria-modal", !0) : undefined,
          this._element.setAttribute? this._element.setAttribute("role", "dialog") : undefined,
          this._element.classList ? this._element.classList.add("show") : undefined;
